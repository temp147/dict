...
import { NutritionanalyzeService } from '../services/nutritionanalyze.js';
...
router.use(useCollection('nb_nutritionanalyze'));

router.post(
	'/',
	asyncHandler(async (req, res, next) => {
		const service = new NutritionanalyzeService({
...
router.post(
	...
	asyncHandler(async (req, res, next) => {
		...
		try {
			// const testlist = req.body['testlist'] ? req.body['testlist'] : [];
